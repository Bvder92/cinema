...
<body>
<?php include_once 'include/header.php'; echo "<br><br><br><br><br><br>"; ?>
	...
	<h1 class = "textprofil" >Profil</h1>
		...
		<div class="content-boxProfil" id="info-content">
			...
			<p>Nom: <?php echo $_SESSION["NomClient"] ?></p>
			<p>Prenom: <?php echo $_SESSION["PrenomClient"] ?></p>
			<p>Email: <?php echo $_SESSION["EmailClient"] ?></p>
		...
		<div class="content-boxProfil hide" id="reservation-content">
			...
			<h2>Réservations</h2>
				<div>
					<p>Film: <?php echo "Film1" ?></p>
					<p>Cinema: <?php echo "Cinema1" ?></p>
